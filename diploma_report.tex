...
\textbf{Сравнительное исследование моделей машинного обучения\\
для прогнозирования удовлетворенности пассажиров авиаперевозок}\\[1.0cm]
...
\begin{flushright}
Студент: Р. Р. Раджабов\\[0.5cm]
Руководитель ВКР: Ю. В. Зонтов
\end{flushright}
...
\chapter*{Актуальность, новизна и предметная область}
\addcontentsline{toc}{chapter}{Актуальность, новизна и предметная область}
...
К элементам новизны относятся: использование единого preprocessing pipeline для шести моделей; подбор и последующее уточнение диапазонов гиперпараметров на основе первичных запусков; анализ поведения моделей на различных группах пассажиров; оценка интерпретируемости через permutation importance; разработка прикладной функции поиска минимально затратного набора изменений признаков, переводящего клиента в класс удовлетворенных пассажиров с точки зрения обученной модели.
...
Предметной областью работы является анализ пассажирского опыта в авиационной отрасли. Объектом исследования являются данные пассажирских опросов, содержащие оценки отдельных элементов сервиса, сведения о типе перелета, характеристиках пассажира и процессе прохождения аэропортовых процедур. Предметом исследования являются методы машинного обучения и способы их оценки при решении задачи бинарной классификации удовлетворенности пассажиров.
...
\bibitem{murphy} Murphy K.P. Machine Learning: A Probabilistic Perspective. MIT Press, 2012.
...
\bibitem{xgbdocs} XGBoost developers. XGBoost Documentation. URL: \url{https://xgboost.readthedocs.io/} (дата обращения: 16.05.2026).
\bibitem{pytorch} PyTorch Foundation. PyTorch Documentation. URL: \url{https://pytorch.org/docs/stable/index.html} (дата обращения: 16.05.2026).
\bibitem{skorch} Skorch developers. Skorch Documentation. URL: \url{https://skorch.readthedocs.io/} (дата обращения: 16.05.2026).
...
\bibitem{github} Rustam432184798213651. Machine learning models study. URL: \url{https://github.com/rustam432184798213651/machine_learning_models_study} (дата обращения: 16.05.2026).
\end{thebibliography}
